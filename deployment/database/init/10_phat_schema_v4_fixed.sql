-- Pinned Week 7 integration contract from DataVision_Phat.
-- Phat remains the schema owner. This snapshot lets Duy's standalone CI and
-- Docker smoke test validate the ingestion writer without network access.
